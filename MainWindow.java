...
public class MainWindow {
	...
	MainWindow(boolean editMode){		
		...
		try{
			...
			ParsedImageIcon departmentLogo = new ParsedImageIcon("resources/electronics/electronics-dept-logo.jpg");
			genericDepartment.setImage(departmentLogo);
			Product genericProduct = new Product(10.0, "Phone", "A lovely new phone", false, genericDepartment, new ParsedImageIcon("resources/electronics/iphone.jpg"));
			genericDepartment.addProduct(genericProduct);
			genericProduct = new Product(15.0, "Computer", "A lovely new computer", true, genericDepartment, new ParsedImageIcon("resources/electronics/desktop.jpg"));
			genericDepartment.addProduct(genericProduct);
			genericProduct = new Product(10.0, "Speakers", "A lovely new set of speakers", false, genericDepartment, new ParsedImageIcon("resources/electronics/speakers.jpg"));
			genericDepartment.addProduct(genericProduct);
			genericProduct = new Product(10.0, "iPod", "A lovely new iPod", false, genericDepartment, new ParsedImageIcon("resources/electronics/ipod.jpg"));
			genericDepartment.addProduct(genericProduct);
			genericProduct = new Product(10.0, "HDMI Cable", "A lovely new HDMI cable", false, genericDepartment, new ParsedImageIcon("resources/electronics/hdmi-cable.jpg"));
			genericDepartment.addProduct(genericProduct);
			
			departments.add(genericDepartment);
			
			genericDepartment = new Department("Bags");
			departmentLogo = new ParsedImageIcon("departmentLogo.png", 300, 300);
			genericDepartment.setImage(departmentLogo);
			genericProduct = new Product(10.0, "Google Bag", "A lovely new Google bag", false, genericDepartment, new ParsedImageIcon("resources/bags/google-bag.jpg"));
			genericDepartment.addProduct(genericProduct);
			genericProduct = new Product(15.0, "Green Duffel", "A lovely new green duffel bag", true, genericDepartment, new ParsedImageIcon("resources/bags/green-duffel.jpg"));
			genericDepartment.addProduct(genericProduct);
			genericProduct = new Product(10.0, "Orange duffel", "A lovely new orange duffel bag", false, genericDepartment, new ParsedImageIcon("resources/bags/orange-duffel.jpg"));
			genericDepartment.addProduct(genericProduct);
			genericProduct = new Product(10.0, "Orange Handbag", "A lovely new handbag", false, genericDepartment, new ParsedImageIcon("resources/bags/"));
			genericDepartment.addProduct(genericProduct);
			genericProduct = new Product(10.0, "Phone", "A lovely new phone", false, genericDepartment, new ParsedImageIcon("resources/bags/"));
			genericDepartment.addProduct(genericProduct);
